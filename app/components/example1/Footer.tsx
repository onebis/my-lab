  ...
  return (
    <footer className='mt-10 w-full bg-gray-400'>
      <div className='mx-auto mt-20 max-w-5xl px-20'>
        <div className='hidden md:flex md:justify-between md:gap-2'>
        ...
        <div className='flex justify-center gap-1 md:hidden'>
          <div className='flex flex-col'>
            <div className='w-52 border-b-1 border-b-amber-200 pb-1'>
              <a href='#' className=' font-playfair uppercase hover:opacity-60'>
                home
              </a>
            </div>
            <div className='mt-2 w-52 border-b-1 border-b-amber-200 pb-1'>
              <a href='#' className=' font-playfair uppercase hover:opacity-60'>
                about
              </a>
            </div>
